...
public class MainController implements Listener {
    ...
    private void setupMapIcon() {
        Image carImage = new Image(getClass().getResource("/com/eryk/images/car.jpg").toExternalForm());
    ...
    private void handleAddCarButton() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/eryk/cargui/add-car-view.fxml"));
